...
public class Constants {
    ...
    public final static int ROAD_WIDTH = 4000;
    public final static int SEG_LENGTH = 200;
    ...
    public final static double MAX_VEL = 400;
    public final static double MAX_ACCEL = 11;
}
